...
| `context/README.md` | Included | Context export command guide, v0.10.0 |
| `context/export-manifest.json` | Included | Ordered context export manifest, v0.10.0 |
...
| `memory/project-kb/features/context-export/FEATURE.md` | Included | Context export feature specification, v0.10.0 |
| `memory/project-kb/features/context-export/CLARIFICATION.md` | Included | Context export clarification decisions, v0.10.0 |
| `memory/project-kb/features/context-export/PLAN.md` | Included | Context export implementation plan, v0.10.0 |
| `memory/project-kb/features/context-export/TASKS.md` | Included | Context export task breakdown, v0.10.0 |
