...
| Area | Status | Notes |
| --- | --- | --- |
| Public repository presentation | Included | README, license, contribution guide, architecture, manifest; v0.9.0 public README is released and v0.10.0 is the current release target |
...
| Context export | Included | Ordered context export manifest, profile-specific local bundle generation commands, and ignored generated output path |
