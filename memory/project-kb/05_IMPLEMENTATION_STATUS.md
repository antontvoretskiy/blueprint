...
| Area | Status | Notes |
| --- | --- | --- |
| Public repository presentation | Included | README, license, contribution guide, architecture, manifest; v0.7.0 public README is released and v0.8.0 is the next release target |
