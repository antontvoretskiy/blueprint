...
| `develop` | Integration branch | Contains bootstrap, complete product map, core contracts, governance standards, self-hosting, Project Memory structure, Project Memory templates, Feature Lifecycle templates, recovery templates, and source coverage maps |
...
Use `PRODUCT_MAP.md` and the coverage matrix to add missing PR handoff templates and Guardian templates in separate scoped PRs.
