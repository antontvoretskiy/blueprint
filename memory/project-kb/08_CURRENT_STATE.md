...
| `develop` | Integration branch | Contains bootstrap, complete product map, core contracts, governance standards, self-hosting, Project Memory structure, Project Memory templates, Feature Lifecycle templates, PR handoff templates, recovery templates, and source coverage maps |
...
Use `PRODUCT_MAP.md` and the coverage matrix to add missing Guardian templates and checklists in separate scoped PRs.
