...
.PHONY: init doctor config quality context-export context-chat context-codex context-cursor context-database context-jsonl up down restart ps logs smoke clean
